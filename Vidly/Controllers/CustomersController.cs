...
namespace Vidly.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,BirthDate,IsSubscribedToNewsletter,MembershipTypeId")] Customer customer)
        {
            ...
            var cust = new ViewModels.NewCustomerViewModel
            {
                Customer = customer,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,BirthDate,IsSubscribedToNewsletter,MembershipTypeId")] Customer customer)
        {
            if (ModelState.IsValid)
            {
